...
@section('content')
<div class="mb-6">
    <a href="{{ route('categories.create') }}" class="bg-amber-600 text-white px-6 py-3 rounded-lg hover:bg-amber-700 transition inline-flex items-center">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        ...
                        <a href="{{ route('categories.edit', $category) }}" class="text-amber-600 hover:text-amber-900 mr-3">Edit</a>
