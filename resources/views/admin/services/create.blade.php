            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-600 focus:border-transparent"
                           placeholder="🍽️ 🥡 🎉 🎂">
                    <p class="mt-1 text-sm text-gray-500">Optional: use an emoji or icon character</p>
                    @error('icon')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Optional: service banner or feature image</p>
                    @error('image_url')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
